...
if [ "$1" == "hs" ]; then
	...
	model="model.hs.npz"
	commandline="-batch_size 200 -max_epoch 10 -valid_per_batch 280 -save_per_batch 280 -decode_max_time_step 750 -optimizer adadelta -rule_embed_dim 128 -node_embed_dim 64 -valid_metric bleu -enable_retrieval"
	datatype="hs"
else
	# django dataset
